...
<Tip>
  Want to skip the manual setup? Use the **Weekly Performance Summary** preset instead — it creates this exact automation with the steps already in place. Or try [Describe It](/automations/describe-it) (Pro and above) to generate it by typing a description.
</Tip>
