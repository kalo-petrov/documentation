...
The **Email Received** trigger runs an automation every time an email is forwarded to a dedicated AffZero forwarding address. This is ideal for capturing invoices, receipts, reports, or any document sent by email — without granting AffZero access to your inbox.
